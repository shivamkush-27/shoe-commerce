  ...
  return (
    <section id='home' className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10'>
      ...
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28'>
        ...
        <p className='font-montserrat text-slate-gray text-lg leading-8 my-6 sm:max-w-sm'>Discover, Stylish Nike arrivals, quality comfort, and innovation for your active life.</p>
      ...
      <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoeImg} alt="Shoe Collection Image" width={610} height={500} className='object-contain relative z-10' />
